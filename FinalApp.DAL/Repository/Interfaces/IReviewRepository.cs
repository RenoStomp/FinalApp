...
namespace FinalApp.DAL.Repository.Interfaces
{
    ...
    public interface IReviewRepository
    {
        ...
        Task<IQueryable<Review>> GetReviewsByEvaluation(int evaluation);
        ...
        /// <returns>An asynchronous operation that returns the collection of reviews.</returns>
        Task<IQueryable<Review>> GetReviewsByRequestId(int requestId);
        ...
        Task<bool> CanCreateReview(int requestId);
        ...
        Task CreateReview(int requestId, string reviewText, int evaluation);
        ...
        Task<bool> CanUpdateReview(int reviewId);
        ...
        /// <returns>An asynchronous operation.</returns>
        Task UpdateReview(int reviewId, string reviewText, int evaluation);
    }
}
